...
public interface IBookRepository
{
    ...
    Task<PagedResult<Book>> GetAllPagedAsync(Guid? genreId, Guid? authorId, string? readingStatus, int pageNumber, int pageSize, CancellationToken cancellationToken = default);
